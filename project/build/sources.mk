...
$(LIBRETS_ANTLR_TRIGGER): $(LIBRETS_ANTLR_GRAMMARS)
	$(ANTLR) -o $(LIBRETS_ANTLR_SRC_DIR) $(LIBRETS_ANTLR_PARSER)
	$(ANTLR) -o $(LIBRETS_ANTLR_SRC_DIR) -glib $(LIBRETS_ANTLR_PARSER) $(LIBRETS_ANTLR_TREE_PARSER)
...
$(LIBRETS_TEST_EXE): $(LIBRETS_TEST_OBJECTS) $(LIBRETS_LIB)
	...
	$(EXPAT_LDFLAGS) $(CPPUNIT_LDFLAGS) $(ANTLR_LDFLAGS)
...
LOGIN_EXAMPLE_SRC_FILES := ${EXAMPLES_SRC_DIR}/login.cpp
...
$(XML_EXE): $(XML_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	$(CXX) -o $(XML_EXE) $(XML_EXAMPLE_OBJECTS) $(LIBRETS_LIB) -lexpat
...
$(GET_OBJECT_EXE): $(GET_OBJECT_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	...
	$(LIBRETS_LIB) $(ANTLR_LDFLAGS) $(CURL_LDFLAGS) $(EXPAT_LDFLAGS)
