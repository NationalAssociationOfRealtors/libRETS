...
EXAMPLES_CFLAGS = $(CFLAGS) $(CXXFLAGS) $(CPPFLAGS) $(BOOST_CFLAGS) 
...
$(LOGIN_EXE): $(LOGIN_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	$(CXX) $(EXAMPLES_CFLAGS) -o $(LOGIN_EXE) $(LOGIN_EXAMPLE_OBJECTS) $(LIBRETS_LIB) \
	$(EXAMPLES_LDFLAGS)

$(SEARCH_EXE): $(SEARCH_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	$(CXX) $(EXAMPLES_CFLAGS) -o $(SEARCH_EXE) $(SEARCH_EXAMPLE_OBJECTS) $(LIBRETS_LIB) \
	$(EXAMPLES_LDFLAGS)

$(DEMO_SEARCH_EXE): $(DEMO_SEARCH_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	$(CXX) $(EXAMPLES_CFLAGS) -o $(DEMO_SEARCH_EXE) $(DEMO_SEARCH_EXAMPLE_OBJECTS) \
	$(LIBRETS_LIB) $(EXAMPLES_LDFLAGS)

$(METADATA_EXE): $(METADATA_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	$(CXX) $(EXAMPLES_CFLAGS) -o $(METADATA_EXE) $(METADATA_EXAMPLE_OBJECTS) $(LIBRETS_LIB) \
	$(EXAMPLES_LDFLAGS)

$(METADATA2DDL_EXE): $(METADATA2DDL_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	$(CXX) $(EXAMPLES_CFLAGS) -o $(METADATA2DDL_EXE) $(METADATA2DDL_EXAMPLE_OBJECTS) $(LIBRETS_LIB) \
	$(EXAMPLES_LDFLAGS)

$(UPDATE_EXE): $(UPDATE_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	$(CXX) $(EXAMPLES_CFLAGS) -o $(UPDATE_EXE) $(UPDATE_EXAMPLE_OBJECTS) $(LIBRETS_LIB) \
	$(EXAMPLES_LDFLAGS)

$(XML_EXE): $(XML_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	$(CXX) $(EXAMPLES_CFLAGS) -o $(XML_EXE) $(XML_EXAMPLE_OBJECTS) $(LIBRETS_LIB) \
	$(EXAMPLES_LDFLAGS)

$(HTTP_EXE): $(HTTP_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	$(CXX) $(EXAMPLES_CFLAGS) -o $(HTTP_EXE) $(HTTP_EXAMPLE_OBJECTS) $(LIBRETS_LIB) \
	$(EXAMPLES_LDFLAGS)

$(RAW_METADATA_EXE): $(RAW_METADATA_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	$(CXX) $(EXAMPLES_CFLAGS) -o $(RAW_METADATA_EXE) $(RAW_METADATA_EXAMPLE_OBJECTS) $(LIBRETS_LIB) \
	$(EXAMPLES_LDFLAGS)

$(RAW_RETS_EXE): $(RAW_RETS_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	$(CXX) $(EXAMPLES_CFLAGS) -o $(RAW_RETS_EXE) $(RAW_RETS_EXAMPLE_OBJECTS) $(LIBRETS_LIB) \
	$(EXAMPLES_LDFLAGS)

$(RAW_SEARCH_EXE): $(RAW_SEARCH_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	$(CXX) $(EXAMPLES_CFLAGS) -o $(RAW_SEARCH_EXE) $(RAW_SEARCH_EXAMPLE_OBJECTS) $(LIBRETS_LIB) \
	$(EXAMPLES_LDFLAGS)

$(SQL2DMQL_EXE): $(SQL2DMQL_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	$(CXX) $(EXAMPLES_CFLAGS) -o $(SQL2DMQL_EXE) $(SQL2DMQL_EXAMPLE_OBJECTS) $(LIBRETS_LIB) \
	$(EXAMPLES_LDFLAGS)

$(GET_OBJECT_EXE): $(GET_OBJECT_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	$(CXX) $(EXAMPLES_CFLAGS) -o $(GET_OBJECT_EXE) $(GET_OBJECT_EXAMPLE_OBJECTS) \
	$(LIBRETS_LIB) $(EXAMPLES_LDFLAGS)

$(INTERLEAVED_EXE): $(INTERLEAVED_EXAMPLE_OBJECTS) $(LIBRETS_LIB)
	$(CXX) $(EXAMPLES_CFLAGS) -o $(INTERLEAVED_EXE) $(INTERLEAVED_EXAMPLE_OBJECTS) \
	$(LIBRETS_LIB) $(EXAMPLES_LDFLAGS)
